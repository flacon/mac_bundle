...
if (NOT TARGET Qt5::Core)
    ...
    set(Qt5Core_PRIVATE_INCLUDE_DIRS
        "${_qt5Core_install_prefix}/lib/QtCore.framework/Versions/5/Headers/5.15.8/"
        "${_qt5Core_install_prefix}/lib/QtCore.framework/Versions/5/Headers/5.15.8/QtCore"
    )
    ...
    set_property(TARGET Qt5::Core
                 ...
                 clock-gettime;datetimeparser;doubleconversion;futimens;glib;hijricalendar;mimetype-database;system-pcre2;poll_poll;sha3-fast)
    set_property(TARGET Qt5::Core
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 etw;futimes;getauxval;getentropy;glibc;gnu-libiconv;icu;posix-libiconv;iconv;inotify;journald;linkat;lttng;poll_ppoll;poll_pollts;poll_select;renameat2;slog2;statx;syslog;system-doubleconversion)
