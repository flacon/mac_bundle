...
set(Qt5Pdf_VERSION_STRING 5.15.11)
...
if (NOT TARGET Qt5::Pdf)
    ...
    set(_Qt5Pdf_OWN_INCLUDE_DIRS
      "${_qt5Pdf_install_prefix}/lib/QtPdf.framework"
      "${_qt5Pdf_install_prefix}/lib/QtPdf.framework/Headers"
    )
    set(Qt5Pdf_PRIVATE_INCLUDE_DIRS
        "${_qt5Pdf_install_prefix}/lib/QtPdf.framework/Versions/5/Headers/5.15.11/"
        "${_qt5Pdf_install_prefix}/lib/QtPdf.framework/Versions/5/Headers/5.15.11/QtPdf"
    )
    ...
    foreach(_module_dep ${_Qt5Pdf_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.11 ${_Qt5Pdf_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::Pdf PROPERTY FRAMEWORK 1)
    ...
    _populate_Pdf_target_properties(RELEASE "QtPdf.framework/QtPdf" "" FALSE)
