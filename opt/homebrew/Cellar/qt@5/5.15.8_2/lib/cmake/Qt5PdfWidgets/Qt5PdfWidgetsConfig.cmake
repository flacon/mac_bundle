...
set(Qt5PdfWidgets_VERSION_STRING 5.15.11)
...
if (NOT TARGET Qt5::PdfWidgets)
    ...
    set(_Qt5PdfWidgets_OWN_INCLUDE_DIRS
      "${_qt5PdfWidgets_install_prefix}/lib/QtPdfWidgets.framework"
      "${_qt5PdfWidgets_install_prefix}/lib/QtPdfWidgets.framework/Headers"
    )
    set(Qt5PdfWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5PdfWidgets_install_prefix}/lib/QtPdfWidgets.framework/Versions/5/Headers/5.15.11/"
        "${_qt5PdfWidgets_install_prefix}/lib/QtPdfWidgets.framework/Versions/5/Headers/5.15.11/QtPdfWidgets"
    )
    ...
    foreach(_module_dep ${_Qt5PdfWidgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.11 ${_Qt5PdfWidgets_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::PdfWidgets PROPERTY FRAMEWORK 1)
    ...
    _populate_PdfWidgets_target_properties(RELEASE "QtPdfWidgets.framework/QtPdfWidgets" "" FALSE)
