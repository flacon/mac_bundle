...
PKG_CONFIG_EXECUTABLE = /opt/homebrew/opt/pkg-config/bin/pkg-config
QMAKE_LIBS_LIBDL = 
QT_COORD_TYPE = double
QMAKE_LIBS_ZLIB = -lz
QMAKE_LIBS_ZSTD = -L/opt/homebrew/Cellar/zstd/1.5.4/lib -lzstd
QMAKE_INCDIR_ZSTD = /opt/homebrew/Cellar/zstd/1.5.4/include
